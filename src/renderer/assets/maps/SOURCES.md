...
The original project assets for Arabia, Arena, Acropolis, and Gold Rush are unchanged.

The following random-map thumbnails were downloaded from their respective
...
- [Four Lakes](https://ageofempires.fandom.com/wiki/Four_Lakes)
- [Golden Swamp](https://ageofempires.fandom.com/wiki/Golden_Swamp)
...
Each local file is the wiki's `Rm <map-name>.png` asset.
