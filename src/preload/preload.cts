...
const electronApi: ElectronGameApi = {
  ...
  runAoe2CreateLobbySequence: (mapName, playerCount, contentKind) =>
    ipcRenderer.invoke("game:run-create-lobby-sequence", mapName, playerCount, contentKind),
  ...
  runAoe2CustomCreateLobbySequence: (mapName, playerCount, contentKind) =>
    ipcRenderer.invoke("game:run-custom-create-lobby-sequence", mapName, playerCount, contentKind),
  runAoe2CustomLobbyCursorAction: (target) => ipcRenderer.invoke("game:run-custom-lobby-cursor-action", target),
  selectAoe2CustomCivilization: (civilization, slot) => ipcRenderer.invoke("game:select-custom-civilization", civilization, slot),
  selectAoe2CustomTeam: (team, slot) => ipcRenderer.invoke("game:select-custom-team", team, slot),
