...
The checked-in source of truth is `src/shared/aoe2UiManifest.ts`. Coordinates are stored in AoE2's 3840Ã—2160 design space and scaled to the live client rectangle immediately before each action.
